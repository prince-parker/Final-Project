...
```{r fig.cap="Figure 2: Wet and Dry Terrain Contingency Table."}
...
```{r}
paste("The number of Sow Bugs that preferred smooth terrain is", smooth_rough_table[1])
```

```{r fig.cap="Figure 3: Terrain Preferences for Bugs."}
# Create the bar plot
